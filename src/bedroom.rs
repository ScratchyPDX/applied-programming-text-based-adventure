...
impl Bedroom {
  ...
  pub fn enter(&self) {
    ...
    print_wrapped_text("It's the middle of the night, and you startled awake by a noise coming from outside the room. What do you do?? GO check out the noise or STAY in bed?");
